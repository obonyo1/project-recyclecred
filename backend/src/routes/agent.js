...
const {
  listAgentDevices, lookupByCode, getAgentDevice,
  submitAssessment, confirmRecycled, agentStats
...
// ── All routes below require agent JWT ───────────────────
router.use(authenticateAgent);

router.get ('/devices/lookup',               lookupByCode);       // ?code=RC-XXXX
